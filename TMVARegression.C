...
void TMVARegression( TString myMethodList = "" , TString fileOptimizeIn="") 
{
   ...
   //    (TMVA::gConfig().GetVariablePlotting()).fTimesRMS = 8.0;
       (TMVA::gConfig().GetIONames()).fWeightFileDir = "regression_weights";
   ...
   for (Int_t var =0; var<numvars;var++){
        ...
        factory->AddVariable( regTree->GetListOfBranches()->At(var)->GetName(),regTree->GetListOfBranches()->At(var)->GetName(),"units",'F');
