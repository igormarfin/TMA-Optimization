...
//TMVA::gConfig().GetVariablePlotting().fNbinsXOfROCCurve=50;
   ...
   ActionButton( cbar,  
                 ...
                 Form( ".x mvaeffs_beforecut.C+(\"%s\",\"B/sqrt(S+B)\",\"plots\",kTRUE,\"0.95\")", fName),
                 "Plots signal and background efficiencies versus cut on classifier output (macro mvaeffs.C)",
                 buttonType, defaultRequiredClassifier );
   ...
   ActionButton( cbar,  
                 ...
                 Form( ".x mvaeffs_beforecut.C+(\"%s\",\"B/sqrt(S+B)\",\"plots\",kTRUE,\"0.90\")", fName),
                 "Plots signal and background efficiencies versus cut on classifier output (macro mvaeffs.C)",
                 buttonType, defaultRequiredClassifier );

   ActionButton( cbar,  
                 Form( "(%ia) Classifier Before-Cut Efficiencies: B/sqrt(S+B)  @B_Purity=0.85", ++ic ),
                 Form( ".x mvaeffs_beforecut.C+(\"%s\",\"B/sqrt(S+B)\",\"plots\",kTRUE,\"0.85\")", fName),
                 "Plots signal and background efficiencies versus cut on classifier output (macro mvaeffs.C)",
                 buttonType, defaultRequiredClassifier );
   ...
   ActionButton( cbar,  
                 ...
                 Form( ".x mvaeffs_beforecut.C+(\"%s\",\"B/S\",\"plots\",kTRUE,\"0.95\")", fName),
                 "Plots signal and background efficiencies versus cut on classifier output (macro mvaeffs.C)",
                 buttonType, defaultRequiredClassifier );

   ActionButton( cbar,  
                 Form( "(%ia) Classifier Before-Cut Efficiencies: B/S @B_Purity=0.90", ++ic ),
                 Form( ".x mvaeffs_beforecut.C+(\"%s\",\"B/S\",\"plots\",kTRUE,\"0.90\")", fName),
                 "Plots signal and background efficiencies versus cut on classifier output (macro mvaeffs.C)",
                 buttonType, defaultRequiredClassifier );

   ActionButton( cbar,  
                 Form( "(%ia) Classifier Before-Cut Efficiencies: B/S @B_Purity=0.85", ++ic ),
                 Form( ".x mvaeffs_beforecut.C+(\"%s\",\"B/S\",\"plots\",kTRUE,\"0.85\")", fName),
                 "Plots signal and background efficiencies versus cut on classifier output (macro mvaeffs.C)",
                 buttonType, defaultRequiredClassifier );
   ...
   ActionButton( cbar,  
                 ...
                 Form( ".x mvaeffs_beforecut.C+(\"%s\",\"B/S\",\"plots\",kTRUE,\"0.80\")", fName),
                 "Plots signal and background efficiencies versus cut on classifier output (macro mvaeffs.C)",
                 buttonType, defaultRequiredClassifier );


   ActionButton( cbar,  
                 Form( "(%ia) Classifier Before-Cut Efficiencies-Purity: B/S  ", ++ic ),
                 Form( ".x mvaeffsPur_beforecut.C(\"%s\",\"B/S\")", fName),
                 "Plots signal and background efficiencies versus purity on classifier output (macro   mvaeffsPur_beforecut.C)",
                 buttonType, defaultRequiredClassifier );

   ActionButton( cbar,  
                 Form( "(%ia) Classifier Before-Cut Efficiencies-Purity: B/sqrt(S+B)  ", ++ic ),
                 Form( ".x mvaeffsPur_beforecut.C(\"%s\",\"B/sqrt(S+B)\")", fName),
                 "Plots signal and background efficiencies versus purity on classifier output (macro   mvaeffsPur_beforecut.C)",
                 buttonType, defaultRequiredClassifier );
   ...
   ActionButton( cbar,  
                 Form( "(%ib) Classifier Background Efficiency vs Signal Efficiency", ++ic ),
                 Form( ".x efficiencies.C(\"%s\",1)", fName ),
                 "Plots background efficiency vs signal efficiencies (macro efficiencies.C)",
                 buttonType, defaultRequiredClassifier );
